            ...
            <v-toolbar color="primary" style="color: white;">
                ...
                <v-dialog v-model="dialog" max-width="500px">
                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            <v-container>
                                <v-text-field v-model="editedItem.email_address" label="メールアドレス" />
                                <v-text-field v-model="editedItem.last_name" label="姓" />
                                <v-text-field v-model="editedItem.first_name" label="名" />
                            </v-container>
                        </v-card-text>
                ...
                <v-dialog v-model="dialogDelete" max-width="500px">
                    <v-card>
                        <v-card-title class="text-h5">「{{ editedItem.email_address }}」のユーザを削除しますか。</v-card-title>
                        <v-card-actions>
                            <v-spacer></v-spacer>
...
export default {
    ...
    computed: {
        formTitle() {
            return this.isEditMode ? 'ユーザ編集' : 'ユーザ追加'
        },
        users() {
